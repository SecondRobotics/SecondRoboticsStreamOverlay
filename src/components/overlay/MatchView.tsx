        ...
        <div className="bg-black/70 backdrop-blur-sm rounded-lg p-4 border border-white/20 shadow-2xl">
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="text-xs text-red-100 opacity-90 space-y-1 text-right">
              {sortedRedOPR.map((player) => (
                <div key={player.username} className="flex items-center justify-end gap-2">
                  <span className="truncate max-w-[100px]">{player.username}</span>
                  <span
                    className={`font-mono bg-red-700/50 px-2 py-1 rounded ${
            ...
            <div className="bg-red-600/80 rounded-lg p-6 text-center min-w-[150px] animate-red-glow">
              <div className={`text-5xl font-mono font-bold ${scoreChanged.red ? 'animate-score-text-change' : ''}`}>
                {animatingScores.red}
              </div>
            </div>
            ...
            <div className="bg-blue-600/80 rounded-lg p-6 text-center min-w-[150px] animate-blue-glow">
              <div className={`text-5xl font-mono font-bold ${scoreChanged.blue ? 'animate-score-text-change' : ''}`}>
                {animatingScores.blue}
              </div>
            </div>

            {/* Blue Alliance OPR */}
            <div className="text-xs text-blue-100 opacity-90 space-y-1 text-left">
              {sortedBlueOPR.map((player) => (
                <div key={player.username} className="flex items-center justify-start gap-2">
                  <span
                    className={`font-mono bg-blue-700/50 px-2 py-1 rounded ${
