...
export default function Field2ResultsPage() {
  ...
  // Map Field 2 properties to Field 1 format for Results component
  ...
  return (
    <div className="min-h-screen bg-transparent text-white relative overflow-hidden">
      ...
      <Results state={field2State} currentTime={currentTime} />
    </div>
  );
}